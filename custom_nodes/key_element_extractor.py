...
def create_key_element_extractor() -> BaseLLMNode:
    node = BaseLLMNode(
        name="KeyElementExtractor",
        prompt=KEY_ELEMENT_EXTRACTOR_PROMPT,
        enable_feedback=False
    )
    return node

key_element_extractor = BaseLLMNode(
    name="KeyElementExtractor",
    prompt=KEY_ELEMENT_EXTRACTOR_PROMPT,
    enable_feedback=False
)
