# ============================================================
# File: module_analyzer.py
# Description:
#   Analyze required functional modules based on gameplay descriptions.
#   These modules will be invoked inside HandleInteraction() of interactive objects.
#   InteractionModule itself must NOT be generated or included.
#   Core modules MUST be ordered by dependency-safe generation order.
# ============================================================
...
# ============================================================
# Revised Prompt: Gameplay-complete, dependency-aware module analysis
# ============================================================
MODULE_ANALYZER_PROMPT = """
...
# ============================================================
# Pre-input logic: Retrieve gameplay_description from GraphState
# ============================================================
def GetInput(node: BaseLLMNode, state: GraphState, full_input: str):
    # Use gameplay_description as the model input
    node.full_input = state.gameplay_description


def create_module_analyzer() -> BaseLLMNode:
    node = BaseLLMNode(
        name="ModuleAnalyzer",
        prompt=MODULE_ANALYZER_PROMPT,
        pre_action=GetInput,
...
# ============================================================
# Node definition (default instance)
# ============================================================
