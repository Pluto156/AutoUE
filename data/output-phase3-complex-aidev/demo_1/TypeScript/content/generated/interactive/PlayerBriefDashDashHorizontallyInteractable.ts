export interface PlayerDashHorizontallyInteractionContext {
  actorName?: string;
  targetName?: string;
...
export function runPlayerDashHorizontallyInteraction(context: PlayerDashHorizontallyInteractionContext = {}): string {
