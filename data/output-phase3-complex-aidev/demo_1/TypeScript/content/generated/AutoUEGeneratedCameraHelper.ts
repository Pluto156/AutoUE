...
export interface AutoUEGeneratedCameraSetupContext {
  orthoWidth?: number;
  armLength?: number;
}
...
export function setupAutoUEGeneratedCamera(actor: UE.Character, options: AutoUEGeneratedCameraSetupContext = {}): UE.CameraComponent | undefined {
  try {
    const self = actor as any;
